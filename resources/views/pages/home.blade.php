<x-layouts.app title="Beranda - Universitas Stella Maris Sumba">
            ...
            <div class="max-w-4xl mx-auto text-center">
                ...
                <div class="relative inline-block group cursor-pointer" @click="videoOpen = true">
                    ...
                    <div class="relative w-20 h-20 md:w-28 md:h-28 bg-unmaris-yellow rounded-full flex items-center justify-center shadow-[0_0_40px_rgba(253,224,26,0.4)] group-hover:scale-105 group-hover:bg-white transition-all duration-300 z-10 border-4 border-white/10">
                        <svg class="w-8 h-8 md:w-10 md:h-10 text-unmaris-blue ml-1.5 md:ml-2" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 md:mb-16 gap-6">
                ...
                <a href="{{ route('news.index') }}" class="hidden md:inline-flex items-center text-unmaris-blue font-black text-xs md:text-sm uppercase tracking-widest hover:text-unmaris-yellow transition group">
                    ...
                    <div class="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center ml-3 group-hover:bg-unmaris-yellow transition-colors">
                        <svg class="w-4 h-4 text-unmaris-blue transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                    </div>
                </a>
            </div>
                        ...
                        <a href="{{ route('news.detail', $item->slug) }}" class="block relative aspect-[4/3] rounded-2xl overflow-hidden mb-4 shadow-sm">
                            ...
                            @else
                                <div class="w-full h-full bg-gray-200 flex items-center justify-center">
                                    <svg class="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                </div>
                            @endif
    ...
    <section class="py-10 border-t border-b border-gray-100 bg-white overflow-hidden">
        ...
        <div class="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500 max-w-5xl mx-auto px-4">
            ...
            <div class="text-xl font-black text-gray-400 flex items-center gap-2"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg> Bank NTT</div>
            <div class="text-xl font-black text-gray-400 flex items-center gap-2"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg> Telkom</div>
            <div class="text-xl font-black text-gray-400 flex items-center gap-2"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg> Pemda Sumba</div>
            <div class="text-xl font-black text-gray-400 flex items-center gap-2"><svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg> Kemdikbudristek</div>
        </div>
    </section>
    ...
    <section class="py-16 md:py-24 relative overflow-hidden bg-unmaris-blue border-t-8 border-unmaris-yellow">
        <div class="absolute inset-0 opacity-10">
            <svg class="h-full w-full" viewBox="0 0 100 100" preserveAspectRatio="none" fill="currentColor"><polygon points="100,100 0,0 100,0"/></svg>
        </div>
        ...
        <div class="container mx-auto px-4 relative z-10 text-center max-w-4xl">
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-4 px-4 md:px-0">
                <a href="https://pmb.unmaris.ac.id" target="_blank" class="w-full sm:w-auto inline-flex items-center justify-center bg-unmaris-yellow text-unmaris-blue font-black text-base md:text-lg px-8 md:px-10 py-4 md:py-5 rounded-full hover:bg-white hover:scale-105 transition-all shadow-[0_10px_30px_rgba(253,224,26,0.3)]">
                    Daftar Sekarang <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </a>
