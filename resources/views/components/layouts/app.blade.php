    ...
    <div x-data="{ waOpen: false }" class="fixed bottom-6 right-6 z-[100] flex flex-col items-end">
        ...
        <div x-show="waOpen"
            ...
            <div class="p-5 space-y-3 bg-gray-50">
                <!-- Kontak 1: CS PMB -->
                <a href="https://wa.me/6281234567890?text=Halo%20Admin%20PMB%20UNMARIS,%20saya%20ingin%20bertanya%20seputar%20informasi%20pendaftaran%20mahasiswa%20baru." target="_blank" class="flex items-center gap-3 p-3 bg-white rounded-xl hover:shadow-lg transition-all border border-gray-100 group transform hover:-translate-y-0.5">
                ...
                <a href="https://wa.me/6281234567891?text=Halo%20Admin%20Akademik%20UNMARIS,%20saya%20ingin%20bertanya%20seputar%20perkuliahan%20dan%20fakultas." target="_blank" class="flex items-center gap-3 p-3 bg-white rounded-xl hover:shadow-lg transition-all border border-gray-100 group transform hover:-translate-y-0.5">
