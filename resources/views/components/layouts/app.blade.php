            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="#" class="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-unmaris-yellow hover:text-unmaris-blue transition"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Kolom 4: Kontak Cepat (Dinami dari Database) -->
                <div class="lg:col-span-1">
